...
def delete_expense():
    ...
    if not selected:
        messagebox.showerror("Error", "Please select expense to delete.")
        return
...
category_dropdown = ttk.Combobox(input_frame, textvariable = category_var, values = ["Food", "Transport", "Rent", "Utilities", "Others"])
...
expense_listbox = tk.Listbox(frame, width = 50, height = 13, yscrollcommand = scrollbar.set, font = ("Arial", 12))
